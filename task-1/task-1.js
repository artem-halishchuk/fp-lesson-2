...
let result = secondEntered + " секунд это " + hours + " " + hoursPrint + " " + minutes + " " + minutesPrint;
alert(result);

let enteredValue = document.querySelector(".in");
enteredValue.innerHTML = "Введенное значение "+ secondEntered + " секунд";
let outValue = document.querySelector(".out");
outValue.innerHTML = result;